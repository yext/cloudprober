workspace(name = "com_github_yext_cloudprober")
...
http_archive(
    ...
    urls = [
        "https://github.com/protocolbuffers/protobuf/archive/v3.12.1.tar.gz",
    ],
)
...
go_repository(
    name = "com_github_hoisie_redis",
    importpath = "github.com/hoisie/redis",
    sum = "h1:mjZV3MTu2A5gwfT5G9IIiLGdwZNciyVq5qqnmJJZ2JI=",
    version = "v0.0.0-20160730154456-b5c6e81454e0",
)
...
go_repository(
    name = "com_github_theothertomelliott_go_must",
    importpath = "github.com/theothertomelliott/go-must",
    sum = "h1:RUWZgKTveZiNNDg0/B2zddw2/Sb8AMEUbwYgA15QBfg=",
    version = "v0.0.0-20180901182306-492b25fad7e5",
)

go_repository(
    name = "com_github_yext_glog",
    importpath = "github.com/yext/glog",
    sum = "h1:PlSmWkpAlwMBoLlNuqOD29g0bWlrZsV/PMRtR7/DWww=",
    version = "v0.0.0-20210527194735-eb643387a7e2",
)
