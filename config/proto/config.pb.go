...
type ProberConfig struct {
	...
	// http://godoc.org/github.com/yext/cloudprober/sysvars.
...
func init() {
	proto.RegisterFile("github.com/yext/cloudprober/config/proto/config.proto", fileDescriptor_config_1514555b909b1ad9)
}
