...
func (*SurfacerConf) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_48ba32453e22249b, []int{0}
}
...
func init() {
	proto.RegisterFile("github.com/yext/cloudprober/surfacers/prometheus/proto/config.proto", fileDescriptor_config_48ba32453e22249b)
}

var fileDescriptor_config_48ba32453e22249b = []byte{
